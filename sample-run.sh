...
# Example:
# */5 * * * * ciuser ( ps aux | grep "testswarm-browserstack/src/cli.js" | grep -v grep || ( /path/to/testswarm-browserstack/run.sh 1>/var/log/testswarm-browserstack/run.log 2>&1 & ) ) > /dev/null 2>&1
#
